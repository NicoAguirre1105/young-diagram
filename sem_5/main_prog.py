...
class Diagram:
    ...
    def simulate(self, n_steps=1000, alpha=1):
        ...
        for step in range(n_steps):
            ...
            self.add_cell(c)
            if step == 500:
                # self.visualize(filename='step500')
                self.visualize(filename='step500_1')
            if step == 8000:
                # self.visualize(filename='step800')
                self.visualize(filename='step800_1')
                
    def visualize(self, tic=0, filename=None):
...
def main():
    ...
    diagram.visualize(tic, filename='diagram_1.png')
